...
DRONE_INIT = [
    {"drone_id": "DRONE-001", "lat": 37.5665, "lng": 126.9780, "heading": 0},
    {"drone_id": "DRONE-002", "lat": 37.5512, "lng": 126.9885, "heading": 90},
    {"drone_id": "DRONE-003", "lat": 37.5789, "lng": 126.9700, "heading": 180},
    {"drone_id": "DRONE-004", "lat": 37.5600, "lng": 126.9950, "heading": 270},
]
...
class Drone:
    ...
    def tick(self):
        ...
        # status (상태 변경 시에만 — MQTT 트래픽 & 게이트웨이 중복 덮어쓰기 방지)
